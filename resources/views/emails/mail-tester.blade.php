        ...
        <tbody>
            <tr>
                <td class="main-table-td">
                    ...
                    <h2 id="mail-title" class="mt-2">{{ get_setting('app_name') }}</h2>
                    <div class="mb-1" id="mail-body">Bonjour Admin</div>
                ...
                <td>
                    <span class="privacy">
                        ...
                        <a href="{{ route('privacy-policy') }}" id="privacy-check"
                            style="{{ (isset($data['privacy']) && $data['privacy'] == 1)?'':'display:none;' }}">{{
                            translate('Privacy_Policy')}}</a>
                        @if (isset($landing_data['refund_policy_status']) && $landing_data['refund_policy_status'] == 1)
                        <a href="{{ route('refund-policy') }}" id="refund-check"
                        ...
                        <a href="{{ route('cancellation-policy') }}" id="cancelation-check"

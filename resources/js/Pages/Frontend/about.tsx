  ...
  return (
    <FrontLayout>
      ...
      >
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-14">
            ...
            >
              ...
              <h1 className="mt-6 text-4xl font-bold leading-[1.02] tracking-tight text-slate-900 dark:text-white md:text-5xl xl:text-6xl">
                {heroTitleBefore} <span className="text-[#da2e29]">{heroTitleHighlight}</span>
                {heroTitleAfter}
              </h1>
        ...
        {/* ── STORY + STATS ── */}
        <section ref={storyRef} className="mx-auto mt-24 max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div
          ...
          >
            <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-white/5 md:p-10 lg:col-span-8">
              ...
              <h2 className="mt-4 text-3xl font-bold tracking-tight md:text-4xl">Mon histoire</h2>
        ...
        {/* ── VALUES ── */}
        {values.length > 0 && (
          <section ref={valuesRef} className="mx-auto mt-24 max-w-7xl px-4 sm:px-6 lg:px-8">
            <motion.div
              variants={sectionReveal}
              initial="hidden"
        ...
        {/* ── TIMELINE ── */}
        {journey.length > 0 && (
          <section ref={timelineRef} className="mx-auto mt-24 max-w-7xl px-4 sm:px-6 lg:px-8">
            <motion.div
              variants={sectionReveal}
              initial="hidden"
                  ...
                  {journey.map((step, idx) => (
                    ...
                    >
                      ...
                      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/5">
                        <div className="text-sm font-semibold text-[#da2e29]">{step.year}</div>
        ...
        {/* ── MISSION ── */}
        <section ref={missionRef} className="mx-auto mt-24 max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div
            variants={sectionReveal}
            initial="hidden"
        ...
        {testimonials.length > 0 && (
          <section ref={testimonialsRef} className="mx-auto mt-24 max-w-7xl px-4 sm:px-6 lg:px-8">
            <motion.div
              variants={sectionReveal}
              initial="hidden"
        ...
        {certifications.length > 0 && (
          <section ref={certificationsRef} className="mx-auto mt-24 max-w-7xl px-4 sm:px-6 lg:px-8">
            <motion.div
              variants={sectionReveal}
              initial="hidden"
        ...
        <section ref={ctaRef} className="mx-auto mt-24 max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-white/90">{ctaSubtitle}</p>

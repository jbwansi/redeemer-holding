                                    ...
                                    <TableCell>
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                <DropdownMenuItem onClick={() => window.location.href = route('formations.participants.show', [formation.slug, participant.id])}>
                                                    <Eye className="h-4 w-4 mr-2" />
                                                    Détails
                                                </DropdownMenuItem>
                                                {participant.status === 'completed' && (
                                                    <DropdownMenuItem onClick={() => window.location.href = route('formations.participants.invoice', [formation.slug, participant.reference])}>
                                                        <Download className="h-4 w-4 mr-2" />
                                                        Facture
                                                    </DropdownMenuItem>
                                                )}

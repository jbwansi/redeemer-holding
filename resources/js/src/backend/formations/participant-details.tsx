...
import {
    ...
    Clock, MapPin, CreditCard, AlertCircle, GraduationCap
} from "lucide-react";
...
const FormationParticipantDetails = ({
    formation,
    participant
}: {
    formation: Formation;
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl font-bold mb-2">
                        Détails de l'inscription à la formation
                    </h1>
                ...
                <div className="flex items-center gap-4">
                    ...
                    {participant.status === 'completed' && (
                        <Button
                            variant="outline"
                            onClick={() => window.location.href = route('formations.participants.invoice', [formation.slug, participant.reference])}
                        >
                    ...
                    <CardContent className="space-y-4">
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                ...
                                <span>
                                    De {new Date(formation.start_date).toLocaleTimeString('fr-FR', {
                                        hour: '2-digit',
                                        minute: '2-digit'
                                    })} à {new Date(formation.end_date).toLocaleTimeString('fr-FR', {
                                        hour: '2-digit',
                                        minute: '2-digit'
                                    })}
                                </span>
                        ...
                        <CardContent>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="font-medium">
                                        {participant.total.toLocaleString('fr-CH')} CHF
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-red-600 mt-1">
                                        Cette inscription peut encore être annulée jusqu'à 24h avant le début de la formation.
                                        {formation.price > 0 && participant.status === 'completed' &&
...
export default FormationParticipantDetails;
...
import { AlertCircle, Mail, ExternalLink, Clock, ShieldAlert, Info, ArrowLeft } from 'lucide-react';
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-sm text-muted-foreground">
                    Contactez notre équipe pour réactiver votre compte ou visitez notre centre
                    d'aide.
                  </p>

    ...
    return (
        <div className="max-w-5xl mx-auto p-4">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground">Modifiez les informations de votre page</p>
            </div>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Permettre la publication ou non de la page</p>
                                </div>
                                <Switch
                                    checked={data.status}

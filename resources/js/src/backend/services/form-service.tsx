...
export default function FormService({ service, mode }: Props) {
    ...
    const [formData, setFormData] = useState<any>({
        ...
        ideal_for: Array.isArray(service?.ideal_for) ? service.ideal_for : typeof service?.ideal_for === "string" && service.ideal_for ? JSON.parse(service.ideal_for) : [],
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        payload.append("ideal_for", JSON.stringify(formData.ideal_for.filter((item: string) => item.trim() !== "")));

...
import { ChevronLeft, Eye, Calendar, Clock, Edit, Trash2, Loader2 } from 'lucide-react';
...
export default function Show({ service }: Props) {
  ...
  const safeExcerpt = React.useMemo(
    () => DOMPurify.sanitize(service.excerpt || ''),
    [service.excerpt]
  );
  const safeContent = React.useMemo(
    () => DOMPurify.sanitize(service.content || ''),
    [service.content]
  );
    ...
    <div className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <Link
                ...
                className="inline-flex items-center text-xs text-muted-foreground hover:text-primary mb-1"
              >
              ...
              <Badge
                ...
                className={
                  service.status
                    ? 'mt-1 bg-emerald-100 text-emerald-700 border-emerald-200'
                    : 'mt-1'
                }
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="lg:col-span-3 space-y-4">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">Description d�taill�e</CardTitle>
            </CardHeader>
            <CardContent>
              <div
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-muted-foreground text-xs">Cr�� le</p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-muted-foreground text-xs">Modifi� le</p>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Cette action est irr�versible. Le service{' '}
              <span className="font-semibold"> {service.name}</span> sera supprim� d�finitivement.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

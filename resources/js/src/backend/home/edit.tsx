                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                Tu peux téléverser plusieurs images ou coller des URLs. Idéalement 3 images maximum.
                                            </p>
                                        </div>
                                    ...
                                    {(m.hero_reassurance_items ?? []).map((item, i) => (
                                        <div key={i} className="flex items-center gap-3">
                                            <Input
                                                ...
                                                onChange={e =>
                                                    setMeta({
                                                        hero_reassurance_items: updateItem(
                                                            m.hero_reassurance_items ?? [],
                                                            i,
                                                            { text: e.target.value }
                                                        ),
                                            ...
                                            <Button
                                                ...
                                                onClick={() =>
                                                    setMeta({
                                                        hero_reassurance_items: removeItem(
                                                            m.hero_reassurance_items ?? [],
                                                            i
                                                        ),
                                                    })

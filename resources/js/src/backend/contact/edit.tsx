      ...
      <form onSubmit={handleSubmit}>
        <Tabs defaultValue="hero" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    value={m.hero_title}
                    onChange={(e) => setMeta({ hero_title: e.target.value })}
                  />
                </div>
                <div>
                  <Label className="mb-2">Mot a surligner en rouge</Label>
                  <Input
                    value={m.hero_highlight}
                    onChange={(e) => setMeta({ hero_highlight: e.target.value })}
                  />
                </div>
                <div>
          ...
          <TabsContent value="form">
            <Card>
              <CardHeader>
                <CardTitle>Formulaire et CTA rendez-vous</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input
                    value={m.form_title}
                    onChange={(e) => setMeta({ form_title: e.target.value })}
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    rows={2}
                    value={m.form_subtitle}
                    onChange={(e) => setMeta({ form_subtitle: e.target.value })}
                  />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      value={m.form_sla_title}
                      onChange={(e) => setMeta({ form_sla_title: e.target.value })}
                    />
                  </div>
                  <div>
                    <Label className="mb-2">Texte bloc reassurance</Label>
                    <Input
                      value={m.form_sla_text}
                      onChange={(e) => setMeta({ form_sla_text: e.target.value })}
                    />
                  </div>
                </div>
                <div className="flex items-center gap-2 rounded-md border p-3">
                  <input
                    ...
                    className="h-4 w-4"
                  />
                  <Label htmlFor="honeypot_enabled" className="mb-0">
                ...
                <div>
                  ...
                  <Input
                    value={m.privacy_text}
                    onChange={(e) => setMeta({ privacy_text: e.target.value })}
                  />
                </div>
                <div>
                  ...
                  <Input
                    value={m.privacy_url}
                    onChange={(e) => setMeta({ privacy_url: e.target.value })}
                  />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      value={m.calendly_title}
                      onChange={(e) => setMeta({ calendly_title: e.target.value })}
                    />
                  </div>
                  <div>
                    <Label className="mb-2">Sous-titre bloc calendly</Label>
                    <Input
                      value={m.calendly_subtitle}
                      onChange={(e) => setMeta({ calendly_subtitle: e.target.value })}
                    />
                  </div>
                </div>
                <div>
                  ...
                  <Textarea
                    rows={2}
                    value={m.calendly_description}
                    onChange={(e) => setMeta({ calendly_description: e.target.value })}
                  />
                </div>
                <div>
                  <Label className="mb-2">Texte bouton calendly</Label>
                  <Input
                    value={m.calendly_button}
                    onChange={(e) => setMeta({ calendly_button: e.target.value })}
                  />
                </div>
                <div>
                  <Label className="mb-2">Preuve sociale (ligne courte)</Label>
                  <Input
                    value={m.calendly_social_proof}
                    onChange={(e) => setMeta({ calendly_social_proof: e.target.value })}
                  />
                </div>
                ...
                <div className="rounded-xl border bg-muted/20 p-4 space-y-3">
                  ...
                  <div className="rounded-lg border border-red-200 bg-red-50/70 px-3 py-2">
                    <p className="text-xs font-semibold text-red-700">
                      {m.form_sla_title || 'Titre reassurance'}
                    </p>
                    <p className="text-xs text-red-800/90">
                      {m.form_sla_text || 'Texte reassurance'}
                    </p>
                  </div>

                  <div className="rounded-lg border bg-background px-3 py-2">
                    <p className="text-xs text-muted-foreground">
                      {m.calendly_social_proof || 'Preuve sociale courte'}
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value="info">
            <Card>
              <CardHeader>
                <CardTitle>Descriptions infos de contact</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <Label className="mb-2">Description email</Label>
                  <Input
                    value={m.email_description}
                    onChange={(e) => setMeta({ email_description: e.target.value })}
                  />
                </div>
                <div>
                  <Label className="mb-2">Description telephone</Label>
                  <Input
                    value={m.phone_description}
                    onChange={(e) => setMeta({ phone_description: e.target.value })}
                  />
                </div>
                <div>
                  <Label className="mb-2">Description adresse</Label>
                  <Input
                    value={m.address_description}
                    onChange={(e) => setMeta({ address_description: e.target.value })}
                  />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button
                  type="button"
                  size="sm"
                  onClick={() => setMeta({ subjects: [...m.subjects, { value: '', label: '' }] })}
                >
                ...
                {m.subjects.map((item, i) => (
                  <div key={i} className="grid grid-cols-1 md:grid-cols-5 gap-3 items-center">
                    <Input
                      ...
                      placeholder="value: coaching"
                      value={item.value}
                      onChange={(e) =>
                        setMeta({ subjects: updateItem(m.subjects, i, { value: e.target.value }) })
                      }
                    />
                    <Input
                      className="md:col-span-2"
                      placeholder="label: Coaching individuel"
                      value={item.label}
                      onChange={(e) =>
                        setMeta({ subjects: updateItem(m.subjects, i, { label: e.target.value }) })
                      }
                    />
                    <Button
                      type="button"
                      variant="ghost"
                      size="sm"
                      onClick={() => setMeta({ subjects: removeItem(m.subjects, i) })}
                    >
          ...
          <TabsContent value="faq">
            <div className="space-y-4">
              <Card>
                <CardHeader>
                  <CardTitle>Titre et lien FAQ</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      value={m.faq_title}
                      onChange={(e) => setMeta({ faq_title: e.target.value })}
                    />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        value={m.faq_link_label}
                        onChange={(e) => setMeta({ faq_link_label: e.target.value })}
                      />
                    </div>
                    <div>
                      <Label className="mb-2">URL lien</Label>
                      <Input
                        value={m.faq_link_url}
                        onChange={(e) => setMeta({ faq_link_url: e.target.value })}
                      />
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                  ...
                  <Button
                    type="button"
                    size="sm"
                    onClick={() => setMeta({ faqs: [...m.faqs, { question: '', answer: '' }] })}
                  >
                    <Plus className="h-4 w-4 mr-1" /> Ajouter
                  </Button>
                </CardHeader>
                    ...
                    <div key={i} className="border rounded-lg p-4 space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <Button
                          ...
                          variant="ghost"
                          size="sm"
                          onClick={() => setMeta({ faqs: removeItem(m.faqs, i) })}
                        >
                          <Trash2 className="h-4 w-4 text-red-500" />
                        </Button>
                      </div>
                      <Input
                        ...
                        value={faq.question}
                        onChange={(e) =>
                          setMeta({ faqs: updateItem(m.faqs, i, { question: e.target.value }) })
                        }
                      />
                      <Textarea
                        rows={3}
                        ...
                        value={faq.answer}
                        onChange={(e) =>
                          setMeta({ faqs: updateItem(m.faqs, i, { answer: e.target.value }) })
                        }
                      />
                    </div>
                  ))}
          ...
          <TabsContent value="map">
            <Card>
              ...
              <CardContent>
                ...
                <Textarea
                  rows={5}
                  value={m.map_embed_url}
                  onChange={(e) => setMeta({ map_embed_url: e.target.value })}
                />
              </CardContent>
            </Card>
          </TabsContent>

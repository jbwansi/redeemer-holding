        ...
        <div className="container mx-auto p-6">
            <div className="space-y-6">
                <Alert>
                    ...
                    <AlertTitle className="text-lg font-semibold">Configuration des connexions sociales</AlertTitle>
                    <AlertDescription>
                        Configurez les différents fournisseurs d'authentification sociale pour permettre aux utilisateurs de se connecter avec leurs comptes existants.
                    </AlertDescription>
                </Alert>
                            ...
                            <TabsContent key={provider.prefix} value={provider.prefix}>
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Configuration du fournisseur {provider.name}
                                        </CardDescription>
                                    </CardHeader>

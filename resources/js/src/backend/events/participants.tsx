        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 text-white/80">
              {event.title} • {event.participant_count} participant
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              onClick={() =>
                (window.location.href = route('events.participants.export', event.slug))
              }
            >
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem
                          onClick={() =>
                            (window.location.href = route('events.participants.show', [
                              event.slug,
                              participant.id,
                            ]))
                          }

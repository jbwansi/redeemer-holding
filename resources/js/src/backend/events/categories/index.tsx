    ...
    <>
      ...
      <div className="p-6 space-y-6">
          ...
          <div className="p-6 border-b">
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-muted-foreground">Gérez les catégories des évènements</p>
              </div>
              ...
              <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle className="text-xl font-semibold">Créer une catégorie</DialogTitle>
                  </DialogHeader>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        {createForm.errors.name && (
                          <p className="mt-1 text-sm text-destructive">{createForm.errors.name}</p>
                        )}
                      </div>
              ...
              <TableBody>
                {filteredCategories.map((category) => (
                  <TableRow key={category.id}>
                    ...
                    <TableCell>
                      <Badge variant="secondary">{category.events_count || 0}</Badge>
                    </TableCell>
                    <TableCell>
        ...
        <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle className="text-xl font-semibold">Modifier la categorie</DialogTitle>
            </DialogHeader>

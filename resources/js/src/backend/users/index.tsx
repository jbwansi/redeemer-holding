...
export default function Index({ users, filters }: Props) {
    ...
    const updateFilters = (newFilters: Partial<typeof filters & { sort?: string; direction?: string }>) => {
        router.get(
            route('users.index'),
            { ...filters, ...newFilters },
            {
                                                ...
                                                <TableRow key={user.id}>
                                                    <TableCell>
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span>
                                                                {getRelativeTime(new Date(user.created_at))}
                                                            </span>
                                                        </div>
                                                    </TableCell>
                                                    <TableCell>
                                ...
                                <div className="flex items-center justify-between px-6 py-4 border-t">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Button
                                            ...
                                            onClick={() => router.get(users.meta.links[users.meta.links.length - 1].url || '')}
                                        >

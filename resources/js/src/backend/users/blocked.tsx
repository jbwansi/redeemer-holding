  ...
  return (
    <>
                ...
                <div className="flex items-center justify-between">
                  <CardTitle>
                    <div className="flex items-center space-x-2">
                      ...
                      <Badge variant="secondary">{blockedUsers.total}</Badge>
                    </div>
                  </CardTitle>
      ...
      <AlertDialog open={!!userToReactivate} onOpenChange={() => setUserToReactivate(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Confirmation de réactivation</AlertDialogTitle>
            <AlertDialogDescription>
              Êtes-vous sûr de vouloir réactiver le compte de{' '}
              <span className="font-medium text-foreground">{userToReactivate?.name}</span>? Cette
              action permettra à l'utilisateur de se reconnecter à son compte.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

            ...
            <div className="p-6 space-y-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Modifiez les textes globaux de vos pages
                    </p>
                </div>
...
<div>
    ...
    <Input
        ...
        accept="image/*"
        onChange={(e) =>
            handleChange("hero_image", e.target.files?.[0] as any)
        }
    />
</div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            handleChange("section_title", e.target.value)
                                        }
                                    />
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) =>
                                            handleChange("section_subtitle", e.target.value)
                                        }
                                    />
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            handleChange("final_cta_title", e.target.value)
                                        }
                                    />
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) =>
                                            handleChange("final_cta_text", e.target.value)
                                        }
                                    />

        ...
        <div className="border-b p-4 bg-background">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Gérez les catégories de votre blog</p>
            </div>
            ...
            <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
              ...
              <DialogContent>
                ...
                <form onSubmit={handleCreate} className="space-y-4">
                  ...
                  <DialogFooter>
                    <Button
                      className=" h-12 rounded-xl text-base font-medium hover:scale-105 transition-transform dark:bg-primary dark:text-white"
                      type="submit"
                      disabled={createForm.processing}
                    >

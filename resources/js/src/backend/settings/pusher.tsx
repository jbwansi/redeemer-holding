...
import { Radio, KeyRound, Wifi, Settings2, Loader } from 'lucide-react';
    ...
    <SettingWrapper>
      <div className="space-y-6">
        <Alert>
          ...
          <AlertDescription>
            Configurez les paramètres de votre application Pusher pour activer les fonctionnalités
            temps réel.
          </AlertDescription>
        </Alert>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Activer/désactiver l'intégration Pusher
                  </p>
                </div>
                <Switch
            ...
            <div className="mt-6 space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Forcer l'utilisation de TLS pour la sécurité
                  </p>
                </div>
                <Switch

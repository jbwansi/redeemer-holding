...
import { Terminal, Server, Mail, Shield, Loader } from 'lucide-react';
      ...
      <SettingWrapper>
        <div className="flex flex-col items-center justify-center h-full space-y-4">
          ...
          <p className="text-lg font-semibold">
            Une erreur s'est produite lors du chargement de la configuration SMTP.
          </p>
        </div>
      </SettingWrapper>
    );
    ...
    <SettingWrapper>
      <div className="space-y-6">
        ...
        <Alert>
          ...
          <AlertTitle className="text-lg font-semibold">Configuration SMTP</AlertTitle>
          <AlertDescription>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={data.port} onValueChange={(value) => setData('port', value)}>

                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    <Tabs defaultValue="password" className="space-y-6">
                        ...
                        <div className="mt-6 space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Exiger au moins une lettre majuscule</p>
                                </div>
                                <Switch
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                <Label className="text-base font-semibold">Durée de verrouillage (minutes)</Label>
                                <Input
                                    type="number"
                        ...
                        <div className="mt-6 space-y-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    <Label className="text-base font-semibold">Double authentification (2FA)</Label>
                            ...
                            {data.enable_2fa && (
                                <div className="flex items-center justify-between">
                                    <div>
                                        <Label className="text-base font-semibold">2FA obligatoire pour les admins</Label>
                                        <p className="text-sm text-muted-foreground">Forcer la 2FA pour les comptes administrateurs</p>
                                    </div>
                                    <Switch
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                <Label className="text-base font-semibold">Durée "Se souvenir de moi" (jours)</Label>
                                <Input
                                    type="number"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div className="md:col-span-2">
                                <Label className="text-base font-semibold">IPs autorisées (séparées par des virgules)</Label>
                                <Input
                        ...
                        <div className="mt-6 space-y-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Enregistrer les actions importantes des utilisateurs</p>
                                </div>
                                <Switch
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Enregistrer les IPs des utilisateurs</p>
                                </div>
                                <Switch

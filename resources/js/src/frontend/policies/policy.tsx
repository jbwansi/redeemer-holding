                ...
                <Card className="max-w-4xl mx-auto p-8">
                    ...
                    <div className="prose dark:prose-invert max-w-none">
                        <p className="lead mb-8">
                            Chez Redeemer Holding, nous accordons une grande importance à la protection de vos données personnelles.
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                ...
                                contre tout accès, modification, divulgation ou destruction non autorisés. Ces mesures incluent :
                            </p>
                            <ul>
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                En général, les données liées aux événements sont conservées pendant une durée de 3 ans
                                après votre dernière participation.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                Notre site utilise des cookies pour améliorer votre expérience. Ces cookies sont utilisés pour :
                            </p>
                            <ul>
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                Nous ne partageons vos données qu'avec des tiers de confiance nécessaires
                            ...
                            <p>
                                ...
                                et ne peuvent pas les utiliser à d'autres fins.
                            </p>
                        </section>

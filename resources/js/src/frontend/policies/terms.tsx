                ...
                <Card className="max-w-4xl mx-auto p-8">
                    ...
                    <div className="prose dark:prose-invert max-w-none">
                        <p className="lead mb-8">
                            Les présentes conditions générales régissent l'utilisation de la plateforme d'événements de Redeemer Holding
                            et la participation aux événements organisés via celle-ci.
                        </p>

                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold mb-4">1. Objet et champ d'application</h2>
                            <p>
                                Ces conditions générales s'appliquent à l'ensemble des services proposés par Redeemer Holding
                                sur sa plateforme d'événements. Elles régissent les relations entre :
                            </p>
                            <ul>
                            ...
                            <p>
                                En utilisant notre plateforme ou en participant à nos événements,
                                vous acceptez ces conditions générales dans leur intégralité.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <ul>
                                ...
                                <li>Remboursement intégral (hors frais de service) si annulation dans les délais</li>
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                Tous les contenus présents sur notre plateforme (textes, images, logos, etc.)
                                sont protégés par les droits de propriété intellectuelle. Leur utilisation
                                sans notre autorisation expresse est interdite.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                Le traitement de vos données personnelles est soumis à notre politique de confidentialité,
                                disponible sur notre site. En acceptant ces conditions, vous acceptez également
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                Nous ne pourrons être tenus responsables en cas d'inexécution de nos obligations
                                due à un cas de force majeure (catastrophe naturelle, épidémie, grève, etc.).
                                Dans ces cas, nous nous engageons à :
                            </p>
                            <ul>
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                Les présentes conditions sont soumises au droit suisse. Tout litige relatif
                                à leur interprétation ou leur exécution relève de la compétence exclusive
                                des tribunaux de Fribourg, Suisse.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <ul>
                                <li>Par email : <a href="mailto:jb.wansi@redeemerholding.com" className="text-red-600 hover:underline">jb.wansi@redeemerholding.com</a></li>
                                <li>Par téléphone : <a href="tel:+41765821109" className="text-red-600 hover:underline">+41 76 582 11 09</a></li>

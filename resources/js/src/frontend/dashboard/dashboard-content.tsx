...
const DashboardContent = ({
    countCurrentFormations,
    countUpGoingFormations,
    CountPastFormations,
    countCurrentEvents,
    countUpGoingEvents,
    CountPastEvents,
    ...
    const totalFormations = countCurrentFormations + countUpGoingFormations + CountPastFormations || 1;
                        ...
                        <div className="flex flex-col md:flex-row items-start gap-8">
                            ...
                            >
                                <div className="flex flex-col space-y-1">
                                    ...
                                    <p className="text-lg font-semibold text-gray-900 dark:text-white">{auth.user.name}</p>
                                </div>
                                ...
                                <div className="h-2 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                                    <motion.div
                                        ...
                                        animate={isStatsInView ? {
                                            width: `${(countCurrentFormations / totalFormations) * 100}%`
                                        } : { width: "0%" }}
                            ...
                            <div>
                                ...
                                <div className="h-2 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                                    <motion.div
                                        ...
                                        initial={{ width: "0%" }}
                                        animate={isStatsInView ? {
                                            width: `${(countUpGoingFormations / totalFormations) * 100}%`
                                        } : { width: "0%" }}
                            ...
                            <div>
                                ...
                                <div className="h-2 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                                    <motion.div
                                        ...
                                        initial={{ width: "0%" }}
                                        animate={isStatsInView ? {
                                            width: `${(CountPastFormations / totalFormations) * 100}%`
                                        } : { width: "0%" }}

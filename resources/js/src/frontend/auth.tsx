            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm">
                        <Link href={route('password.request')} className="font-medium text-[#DA2E29] hover:text-[#c02824] transition-colors">
                            Mot de passe oublié?
                        </Link>
                    </div>
                </div>
                ...
                <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                        <label htmlFor="terms" className="text-gray-700 dark:text-gray-300">
                            J'accepte les{' '}
                            <Link href={route('terms.show')} className="text-[#DA2E29] hover:text-[#c02824] transition-colors">
                                conditions d'utilisation
                            </Link>
                            {' '}et la{' '}
                            <Link href={route('policy.show')} className="text-[#DA2E29] hover:text-[#c02824] transition-colors">

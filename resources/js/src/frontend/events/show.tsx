                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex">
                                                    <div>
                                                        ...
                                                        {!isEventPassed && event.available_seats > 0 && event.available_seats <= 5 && (
                                                            <p className="text-amber-600 dark:text-amber-400 text-sm font-medium mt-1">
                                                                Plus que {event.available_seats} place{event.available_seats > 1 ? 's' : ''} disponible{event.available_seats > 1 ? 's' : ''} !
                                                            </p>
                                                        )}

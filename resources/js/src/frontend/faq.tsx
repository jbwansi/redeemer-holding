    ...
    faqs: [
        {
            ...
            answer: 'Les séances se déroulent en visioconférence ou en présentiel selon votre préférence. Nous définissons d\'abord vos objectifs puis un plan d\'action concret.',
        },
        {
            question: 'Combien de séances sont nécessaires ?',
            answer: 'Le nombre de séances dépend de vos objectifs. En général, un accompagnement se construit sur plusieurs sessions adaptées à votre rythme.',
        },
        {
            question: 'Proposez-vous des tarifs dégressifs ?',
            answer: 'Oui, des forfaits sont proposés selon les besoins. Contactez-nous pour obtenir une proposition personnalisée.',
        },
    ],
};
...
export default function FaqPage({ page, faqs = [] }: any) {
    ...
    const faqsToShow = Array.isArray(faqs) && faqs.length > 0
        ? faqs
        : (Array.isArray(meta.faqs) ? meta.faqs : []);

...
const ContactPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        router.post(route('contact'), formData, {
            onSuccess: () => {
                ...
                <div className="max-w-[1400px] mx-auto px-4 md:px-8 relative z-10">
                    ...
                    >
                        <iframe
                            ...
                            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d43692.81579896015!2d7.175105!3d46.808226!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478e691661b56407%3A0xb72fd47cc9f3dc72!2sAv.%20Jean-Marie-Musy%205%2C%201700%20Fribourg%2C%20Suisse!5e0!3m2!1sfr!2sus!4v1740007896823!5m2!1sfr!2sus"
                            width="100%"
                            height="100%"
                            style={{ border: 0 }}
                            allowFullScreen

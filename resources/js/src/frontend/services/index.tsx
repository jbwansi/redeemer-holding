            ...
            >
                        ...
                        {filteredServices.map((service, idx) => (
                            ...
                            >
                                ...
                                <div className="px-5 pb-6">
                                    ...
                                    {service.tagline && (
                                        <p className="mt-1 text-sm font-bold text-[#da2e29]">
                                            {service.tagline}
                                        </p>
                                    )}
                                    ...
                                    <div className="mt-7 flex flex-wrap gap-3">
                                        ...
                                        <Link
                                            ...
                                            className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-5 py-3 text-sm font-bold text-slate-700 transition hover:bg-slate-100 dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:hover:bg-white/10"
                                        >
                ...
                >
                    ...
                    >
                        ...
                        <p className="mt-3 max-w-2xl text-slate-600 dark:text-slate-300">
                            {pageContent.process_subtitle || "Un processus simple en trois étapes pour garantir l'alignement et l'exécution."}
                        </p>
                ...
                >
                    ...
                    >
                        ...
                        <p className="mt-3 max-w-2xl text-slate-600 dark:text-slate-300">
                            {pageContent.faq_subtitle || 'Les réponses rapides aux questions les plus posées avant de démarrer.'}
                        </p>
                    </motion.div>
                        ...
                        <div className="relative z-10 flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
                            <div className="max-w-3xl">
                                ...
                                <p className="mt-4 text-base leading-8 text-white/90 md:text-lg">
                                    {pageContent.final_cta_text || "Réservez un premier échange pour clarifier vos besoins et choisir le meilleur format d'accompagnement."}
                                </p>
                            </div>

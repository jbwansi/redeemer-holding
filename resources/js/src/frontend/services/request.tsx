                            ...
                            >
                                ...
                                <motion.div variants={itemVariants} className="mb-8">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-300">
                                        Complétez le formulaire ci-dessous pour soumettre votre demande. Nous vous répondrons dans les plus brefs délais.
                                    </p>
                                </motion.div>
                                        ...
                                        <motion.div variants={itemVariants}>
                                            ...
                                            <div className="relative rounded-md">
                                                ...
                                                <input
                                                    ...
                                                    required
                                                    className={`block w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-800/60 border ${errors.first_name ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' :
                                        ...
                                        <motion.div variants={itemVariants}>
                                            ...
                                            <div className="relative rounded-md">
                                                ...
                                                <input
                                                    ...
                                                    required
                                                    className={`block w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-800/60 border ${errors.last_name ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' :
                                                        'border-gray-200 dark:border-gray-700 focus:ring-[#DA2E29] focus:border-[#DA2E29]'
                                                        } rounded-lg shadow-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-opacity-50`}
                                        ...
                                        <motion.div variants={itemVariants}>
                                            ...
                                            <div className="relative rounded-md">
                                                ...
                                                <input
                                                    ...
                                                    required
                                                    className={`block w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-800/60 border ${errors.email ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' :
                                                        'border-gray-200 dark:border-gray-700 focus:ring-[#DA2E29] focus:border-[#DA2E29]'
                                                        } rounded-lg shadow-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-opacity-50`}
                                        ...
                                        <motion.div variants={itemVariants}>
                                            ...
                                            <div className="relative rounded-md">
                                                ...
                                                <input
                                                    ...
                                                    className={`block w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-800/60 border ${errors.phone ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' :
                                                        'border-gray-200 dark:border-gray-700 focus:ring-[#DA2E29] focus:border-[#DA2E29]'
                                                        } rounded-lg shadow-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-opacity-50`}
                                    ...
                                    <motion.div variants={itemVariants} className="mt-6">
                                        ...
                                        <div className="relative rounded-md">
                                            ...
                                            <textarea
                                                ...
                                                required
                                                rows={5}
                                                className={`block w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-gray-800/60 border ${errors.message ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' :
                                                    'border-gray-200 dark:border-gray-700 focus:ring-[#DA2E29] focus:border-[#DA2E29]'
                                                    } rounded-lg shadow-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-opacity-50`}
                                ...
                                <div className="p-6">
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-start">
                                            ...
                                            <span className="text-gray-600 dark:text-gray-300">Consultation initiale pour évaluer vos besoins</span>
                                        </li>
                                        <li className="flex items-start">
                                            <CheckCircle className="h-5 w-5 text-[#DA2E29] mt-0.5 mr-3 flex-shrink-0" />
                                            <span className="text-gray-600 dark:text-gray-300">Plan d'action personnalisé</span>
                                        </li>
                                        <li className="flex items-start">
                                            <CheckCircle className="h-5 w-5 text-[#DA2E29] mt-0.5 mr-3 flex-shrink-0" />
                                            <span className="text-gray-600 dark:text-gray-300">Suivi régulier de vos progrès</span>
                                        </li>
                                        <li className="flex items-start">
                                            <CheckCircle className="h-5 w-5 text-[#DA2E29] mt-0.5 mr-3 flex-shrink-0" />
                                            <span className="text-gray-600 dark:text-gray-300">Ressources et outils exclusifs</span>
                                        </li>
                                    </ul>
                                </div>
                            </motion.div>

...
export default function FrequentEventsGallery({
    ...
    const showPrev = useCallback(() =>
        setLightboxIndex((i) => (i !== null ? (i - 1 + galleryItems.length) % galleryItems.length : null)), [galleryItems.length]);
    const showNext = useCallback(() =>
        setLightboxIndex((i) => (i !== null ? (i + 1) % galleryItems.length : null)), [galleryItems.length]);

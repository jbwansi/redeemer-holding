  ...
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-sm text-sm text-gray-500 dark:text-gray-400">
        De nouvelles sessions sont régulièrement ajoutées. Revenez bientôt ou contactez-nous pour
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <div className="mt-auto border-t border-gray-100 pt-4 dark:border-gray-800 flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className={`group/btn inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-white transition-colors duration-200 ${
                          full

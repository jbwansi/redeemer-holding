  ...
  return (
    <>
      <motion.article
        ...
        className="group flex h-full flex-col overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-3 shadow-xl shadow-slate-900/5 backdrop-blur transition hover:-translate-y-1 hover:border-[#da2e29]/40 dark:border-white/10 dark:bg-[#0b1424] dark:shadow-black/25"
      >
        {/* Image */}
        <div className="relative overflow-visible">
          <button
            ...
            className="group/image relative block aspect-[16/9] w-full cursor-zoom-in overflow-hidden rounded-[1.25rem]"

...
const FormationJoin = ({ formation, auth }: any) => {
    ...
    return (
        <div id="inscription" className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-700 mb-6">
            <div className="p-6 md:p-7">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label htmlFor="formation-first_name" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                                Prénom
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label htmlFor="formation-last_name" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                                Nom
                            </label>
                            <input
                                type="text"
                    ...
                    {/* Adresse e-mail */}
                    <div>
                        <label htmlFor="formation-email" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
                            Adresse e-mail
                        </label>
                        <input
                            type="email"
                        ...
                        >
                            {processing ? (
                                ...
                                <>
                                    ...
                                    {formation.price > 0 ? 'Procéder au paiement' : 'Réserver gratuitement'}
                                </>
                            )}
                        </button>
